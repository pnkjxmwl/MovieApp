package com.example.movieapp.presentation.detail_sc
...
import com.example.movieapp.presentation.detail_sc.components.ErrorScreen
import com.example.movieapp.presentation.detail_sc.components.LoadingScreen
import com.example.movieapp.presentation.detail_sc.components.MovieData
...
fun DetailScreen(
    ...
    Scaffold(
            ...
            TopAppBar(title = {
                ...
                navigationIcon = {
                    IconButton(onClick = { /*TODO*/ }) {
                            Icon(imageVector = Icons.Rounded.LocalMovies, contentDescription = null)
                    }
                }
                )
        }
        ...
        paddingValues ->
        AnimatedContent(targetState = movieDataResponse,
